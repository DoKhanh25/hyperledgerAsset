...
class AssetTransfer extends Contract {
    ...
    async CreateAsset(ctx, id, title, hashValue, doi, authorName, authorIdentity, acceptBy, updateTime, updateBy) {
    ...
    async UpdateAsset(ctx, id, title, hashValue, doi, authorName, authorIdentity, acceptBy, updateTime, updateBy) {
        const exists = await this.AssetExists(ctx, id);
        if (!exists) {
            throw new Error(`The asset ${id} does not exist`);
        }
